      ...
      <Navbar />
        ...
        <div className='flex flex-col md:flex-row-reverse items-center justify-center gap-6 px-6 md:px-48 md:pt-24 py-10'>
            ...
            <div className='md:py-24 flex flex-col gap-6 md:w-1/2 w-full'>
                <h1 className='font-poppins text-3xl md:text-5xl font-semibold'>Psychologists at Coral</h1>
                <div className='h-[4px] w-1/3 bg-gradient-to-r from-primary to-secondary'></div>
                <p className='text-xl font-cabin text-light'>
                We have the best psychologists here at Coral who are always ready to help you out. They are well trained and are highly qualified too. Psychologists at Coral are friendly and always ensure that you are comfortable with sharing your personal issues with them.
                </p>
            </div>
        </div>
